...
export function AboutUs() {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col pt-32 text-white bg-black">
            {/* Hero Section */}
            <div className="px-16 flex flex-col lg:flex-row items-center justify-between mb-16">
                <div className="flex flex-col flex-1 gap-8">
                    <h2 className="text-4xl font-bold bg-gradient-to-r 
                                          from-yellow-500 to-amber-300 bg-clip-text text-transparent">
                        About Us
                    </h2>
                    ...
                    <div className="flex gap-4">
                        <a href="#" className="text-2xl text-gray-400 hover:text-amber-400"><FaFacebook /></a>
                        <a href="#" className="text-2xl text-gray-400 hover:text-amber-400"><FaTwitter /></a>
                        <a href="#" className="text-2xl text-gray-400 hover:text-amber-400"><FaInstagram /></a>
                        <a href="#" className="text-2xl text-gray-400 hover:text-amber-400"><FaYoutube /></a>
                    </div>
                </div>
                <div className="flex-1">
                    <img className="rounded-2xl shadow-lg border border-amber-500/30 hover:shadow-amber-500/20 transition-shadow duration-300" 
